...
function navigator(status,uid)
{
    ...
    */
    ...
    if (status == 1)
    {
        nav.innerHTML = "<img src=\"../civitas/img/CIVITAS2.png\" width=\"120px\" height=\"25px\" class=\"civitas2\"/><span class=\"vertime\">Pre-Alpha 0.0.9<p id=\"time\" class=\"time\"></p></span><span><a href=\"#street\"><img src=\"\
    ...
    {
        nav.innerHTML = "<img src=\"../civitas/img/CIVITAS2.png\" width=\"120px\" height=\"25px\" class=\"civitas2\"/><span class=\"vertime\">Pre-Alpha 0.0.9<p id=\"time\" class=\"time\"></p></span><span><a href=\"1.html\"><img src=\"../civitas/svg/common/blog.svg\" width=\"22px\" height=\"22px\"/>开发日志</a></span><span class=\"signup-in\"><a href=\"../login.html\">登录</a><a href=\"../register.html\">注册</a></span>"
    }
    date_navigator();
}
